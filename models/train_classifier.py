...
def tokenize(text):
    ...
    #identifies and replaces url with a 'urlplaceholder'
    ...
    #create a list from clean tokens
...
def build_model():
    '''
    Create a modelwith GridSearchCV
    input: 
    output: model after performing grid search
    '''
...
def save_model(model, model_filepath):
    ...
    output: Filepath to save the model
    '''
